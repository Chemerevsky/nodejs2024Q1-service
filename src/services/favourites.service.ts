...
import { Favorites, FavoritesGetAllResponse, FavoritesResponse } from '../interfaces/favorites.interface';
...
export class FavouritesService {
    ...
    findAll(): FavoritesGetAllResponse {
        const artists: Artist[] = this.artistsService.findByIds(this.favourites.artists);
        const albums: Album[] = this.albumsService.findByIds(this.favourites.albums);
